 ...
 */
final class Version20220815094705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, fillier_id INT NOT NULL, promotion_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, numero INT NOT NULL, telephone VARCHAR(255) NOT NULL, scolariter_payer INT NOT NULL, inscription_payer TINYINT(1) NOT NULL, INDEX IDX_717E22E322FE6A41 (fillier_id), INDEX IDX_717E22E3139DF194 (promotion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fillier (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, niveau INT NOT NULL, scolariter_apayer INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
